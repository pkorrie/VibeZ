...
-- create 6 "posts" or 1 post with 4 comments of varying depth, and a second top level post
    ...
    VALUES
    (1, 'username1', 'top level post! parent id is null. click on me to see comments.', CURRENT_TIMESTAMP, 'https://i.pinimg.com/originals/44/e2/42/44e2422c7ecf1e9234c7fa4cdf03f060.jpg', null, 'first title');

    -- second is a "comment" which is just a nested post with parent id of 1, referencing the first post we just created.
    INSERT INTO public.posts
    (id, username, content, timestamp, image, parent_id, title)
    VALUES
    (2, 'username2', 'comment or nested post, parent id is 1', CURRENT_TIMESTAMP, 'https://i.pinimg.com/originals/44/e2/42/44e2422c7ecf1e9234c7fa4cdf03f060.jpg', 1, 'second title');
    ...
    (id, username, content, timestamp, image, parent_id, title)
    VALUES
    (6, 'username3', 'what is your favorite cat food??', CURRENT_TIMESTAMP, 'https://i.pinimg.com/originals/44/e2/42/44e2422c7ecf1e9234c7fa4cdf03f060.jpg', null, 'another title');
